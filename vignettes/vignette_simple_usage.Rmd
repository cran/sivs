...
%\VignetteIndexEntry{Seed Independent Variable Selection (SIVS)}
-->
...
sivs_obj <- sivs::sivs(x = train_x,           # it should be a matrix or datafram with features as columns and samples as rows
                       y = factor(train_y),
